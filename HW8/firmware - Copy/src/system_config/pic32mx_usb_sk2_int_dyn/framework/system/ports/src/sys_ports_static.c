...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_DirectionOutputSet( PORTS_ID_0, PORT_CHANNEL_B,  0x0010);
    ...
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_B,  0x0);

    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_B, 0);
    
    //User button set

    PLIB_PORTS_ChannelModeSelect( PORTS_ID_0, PORT_CHANNEL_B, 0x2000, PORTS_PIN_MODE_DIGITAL);
